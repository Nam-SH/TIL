...
2. user 레코드 생성
   ...
   ```python
   # orm
   User.objects.create(first_name='승현', last_name='놤', age=22, country='독도', phone='010-4882-8282', balance=9999)
   ```

   ```sql
   -- sql
   INSERT INTO users_user VALUES (102, '승현', '놤', 22, '독도', '010-4882-8282', 9999)
   ```
